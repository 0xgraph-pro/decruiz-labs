...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    summary: "Lead the design and development of scalable blockchain infrastructure, smart contracts, and cross-chain systems across our Web3 ecosystem spanning gaming, DeFi, and tokenized real-world assets.",
  },
  {
  ...
  },
  {
    ...
    salaryRange: "$250k – $280k",
    icon: Code,
    gradient: "from-emerald-500 to-cyan-600",
    summary: "Lead and scale engineering teams to deliver secure, high-performance Web3 products, driving architecture, execution, and technical excellence across DeCruiz’s decentralized platforms.",
  },
  {
    ...
    location: "Remote / Global",
    type: "Full-time / Part-time",
    salaryRange: "$420k – $450k",
    icon: Code,
    gradient: "from-emerald-500 to-cyan-600",
    summary: "Provide strategic technical guidance across DeCruiz’s Web3 ecosystem, advising on architecture, scalability, and blockchain innovation to ensure robust, secure, and future-ready products.",
  },
  {
